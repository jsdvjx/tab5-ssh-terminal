...
void hid_send_key(uint8_t usage, uint8_t modifiers)
{
    ...
    switch (usage) {
    case HID_KEY_UP:    n = term_encode_key(s_term, TERM_KEY_UP, buf, sizeof(buf)); break;
    case HID_KEY_DOWN:  n = term_encode_key(s_term, TERM_KEY_DOWN, buf, sizeof(buf)); break;
    case HID_KEY_RIGHT: n = term_encode_key(s_term, TERM_KEY_RIGHT, buf, sizeof(buf)); break;
    case HID_KEY_LEFT:  n = term_encode_key(s_term, TERM_KEY_LEFT, buf, sizeof(buf)); break;
    case HID_KEY_HOME:        n = term_encode_key(s_term, TERM_KEY_HOME, buf, sizeof(buf)); break;
    case HID_KEY_END:         n = term_encode_key(s_term, TERM_KEY_END, buf, sizeof(buf)); break;
    case HID_KEY_PAGEUP:      n = term_encode_key(s_term, TERM_KEY_PGUP, buf, sizeof(buf)); break;
    case HID_KEY_PAGEDOWN:    n = term_encode_key(s_term, TERM_KEY_PGDN, buf, sizeof(buf)); break;
    case HID_KEY_DELETE:      n = term_encode_key(s_term, TERM_KEY_DELETE, buf, sizeof(buf)); break;
    default: {
